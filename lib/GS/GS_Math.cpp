        ...
        glm::vec3 &scale)
{
    ...
    if (cos(rotation.y) != 0)
    {
        rotation.x = (float)atan2(
                static_cast<double>(Row[1][2]), static_cast<double>(Row[2][2]));
        rotation.z = (float)atan2(
                static_cast<double>(Row[0][1]), static_cast<double>(Row[0][0]));
    }
    else
    {
        rotation.x = (float)atan2(
